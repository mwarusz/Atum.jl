...
function run(A, FT, N, K; volume_form=WeakForm(), outputvtk=true)
  ...
  grid = brickgrid(cell, (vx, vx, vz); periodic = (true, true, false))
  ...
  timeend = dt
  @CUDA.profile solve!(q, timeend, odesolver; after_step=do_output)
